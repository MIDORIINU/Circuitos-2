function P11f_I_step_big_signal(spice_directory, points_directory, ...
...
simulation_name = 'P11f_I_step_big_signal';
...
simulation_vin_limits = [0 0.9];

simulation_vin_ticks = (0 :0.05:0.9);

simulation_vout_limits = [-30 30];

simulation_vout_ticks = (-30:3:30);
...
simulation_save_name = 'P11f_I_step_big_signal_zoom';
