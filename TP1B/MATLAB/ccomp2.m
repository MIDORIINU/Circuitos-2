function ccomp2(spice_directory, loop_directory, rf_directory, ...
...
component_values = {'0', '2n', '5n'};
component_labels = {'0', '2nF', '5nF'};
...
simulation_name = 'power_supply_CCOMP2_LOOP_Modo1';

simulation_directory = 'Ccomp2_tensión';

parametric_labels = {'0', '2nF', '5nF'};

simulation_title = strjoin({'Ganancia de lazo ', ...
    '$ \left( a \cdot f \right)', ...
    '_{ \left( j \cdot \omega \right)} $', ...
    ' parametrizada por Ccomp2 en modo tensi\''{o}n, 10V, carga de 1A'}, '');
...
% simulation_name = 'power_supply_CCOMP2_LOOP_Modo2';
%
% simulation_title = ...
%     strjoin({'Ganancia de lazo $ \left( a \cdot f \right)', ...
%     '_{ \left( j \cdot \omega \right)} $', ...
%     ' parametrizada por Ccomp2 en modo tensi\''{o}n, 1V, carga de 1A'}, '');
%
% simulation_prealocation_count = 65000;
%
% simulation_mod_limits = [-150 100];
...
simulation_name = 'power_supply_CCOMP2_RF_Modo1';
...
simulation_ang_ticks = (-210 :30: 60);
...
% simulation_name = 'power_supply_CCOMP2_RF_Modo2';
%
% simulation_title = strjoin({'Respuesta en frecuencia $', ...
%     ' \left( \frac{V_{o}}{V_{Ref}} \right)', ...
%     '_{ \left( j \cdot \omega \right)} $', ...
...
simulation_name = sprintf('power_supply_CCOMP2_%s_STEP_Modo1', ...
    component_value);
...
simulation_name = sprintf('power_supply_CCOMP2_%s_STEP_Modo2', ...
    component_value);
