function ramort(spice_directory, loop_directory, rf_directory, ...
...
component_values = {'0', '1', '5'};
component_labels = {'0', '1\Omega', '5\Omega'};
...
simulation_name = 'power_supply_RAMORT_LOOP_Modo1';

simulation_directory = 'Ramort_tensión';

parametric_labels = {'0', '1\Omega', '5\Omega'};

simulation_title = strjoin({'Ganancia de lazo ', ...
    '$ \left( a \cdot f \right)', ...
    '_{ \left( j \cdot \omega \right)} $', ...
    ' parametrizada por Ramort en modo tensi\''{o}n, 10V, carga de 1A'}, '');
...
simulation_name = 'power_supply_RAMORT_LOOP_Modo2';

simulation_title = ...
    strjoin({'Ganancia de lazo $ \left( a \cdot f \right)', ...
    '_{ \left( j \cdot \omega \right)} $', ...
    ' parametrizada por Ramort en modo tensi\''{o}n, 1V, carga de 1A'}, '');
...
simulation_name = 'power_supply_RAMORT_RF_Modo1';
...
simulation_mod_limits = [-70 70];

simulation_mod_ticks = (-70:10:70);

simulation_ang_limits = [-300 210];

simulation_ang_ticks = unique(sort([(-300 :30: 210) 0]),'first');
...
simulation_name = 'power_supply_RAMORT_RF_Modo2';
...
simulation_name = sprintf('power_supply_RAMORT_%s_STEP_Modo1', ...
    component_value);
...
simulation_current_limits = [0 1.5];

simulation_current_ticks = (0 :0.1:1.5);
...
simulation_name = sprintf('power_supply_RAMORT_%s_STEP_Modo2', ...
    component_value);
