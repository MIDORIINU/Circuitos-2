...
graphic_handle = loop_gain(...
    ...
    'Ganancia de lazo $ \left( a \cdot f \right) $ parametrizada por Ccomp en modo corriente, 2A', ...
...
graphic_handle = loop_gain(...
    ...
    'Ganancia de lazo $ \left( a \cdot f \right) $ parametrizada por Ccomp en modo corriente, 200mA', ...
    100, [1 0.4 0.1; 0.4 1 0.1; 0.4 0.1 1], ...
    65000, 3, ...
    [-150 100], (-150:25:100), ...
    [-500 50], sort([(-500 :50: 50) -180]), ...
...
graphic_handle = rf(...
    ...
    'Respuesta en frecuencia $ \left( \frac{I_{L}}{V_{Ref}} \right) $ parametrizada por Ccomp en modo corriente, 2A', ...
    100, [1 0.4 0.1; 0.4 1 0.1; 0.4 0.1 1], ...
    65000, 3, ...
    [-65 30], (-65:10:30), ...
    [-240 60], (-240 :30: 60), ...
...
graphic_handle = rf(...
    ...
    'Respuesta en frecuencia $ \left( \frac{I_{L}}{V_{Ref}} \right) $ parametrizada por Ccomp en modo corriente, 200mA', ...
    100, [1 0.4 0.1; 0.4 1 0.1; 0.4 0.1 1], ...
    65000, 3, ...
    [-70 50], (-70:10:50), ...
    [-190 80], (-190 :30: 80), ...
