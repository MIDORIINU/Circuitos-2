...
\newcommand{\titulo}{Trabajo práctico N\textdegree \hspace{1pt} 1B}
\newcommand{\titulolargo}{Análisis de estabilidad y compensación de una fuente lineal}
...
\newcommand{\thedate}{06 de Mayo de 2019}
